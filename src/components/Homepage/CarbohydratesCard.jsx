    ...
    return (
        <div className="card">
            <div className="card-body">
                <h5 className="card-title"> Carbohydrates</h5>
                ...
                <h6 className="card-subtitle mb-2 text-muted">Types of Carbohydrates:</h6>
                <p className="card-text">
                    <strong>Simple carbs:</strong><br/>
                    - Includes naturally sweet foods, such as fruits, vegetables, and milk as well as foods that have sugar added to them throughout the manufacturing and refining process.<br/>
                    - More easily converted to glucose, which is utilized for energy.<br/>
                ...
                <p className="card-text">
                    <strong>Complex or starchy carbs:</strong><br/>
                    - Complex or starchy carbohydrates take longer to digest, providing less energy and keeping you satisfied for a longer period of time.<br/>
                    - Whole grains, legumes, vegetables, and fruits are examples of healthy carbohydrates.<br/>
