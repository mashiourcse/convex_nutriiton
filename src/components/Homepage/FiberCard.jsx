    ...
    return (
        <div className="card">
            <div className="card-body">
                ...
                <h6 className="card-subtitle mb-2 text-muted">Types of Fiber:</h6>
                <p className="card-text">
                    <strong>Soluble fiber:</strong><br/>
                    - Enhances digestion, allowing the stomach to empty more slowly.<br/>
                    - Nutrients are absorbed gradually, allowing for a consistent flow of energy.<br/>
                    - Helps reduce dangerous low-density lipoprotein cholesterol.
                </p>
                <p className="card-text">
                    <strong>Insoluble fiber:</strong><br/>
                    - Does not dissolve in water and remains mainly intact through the digestive system.<br/>
                    - Helps the digestive system run smoothly.<br/>
