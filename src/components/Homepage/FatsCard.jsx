    ...
    return (
        <div className="card">
            <div className="card-body">
                ...
                <ul>
                    <li><strong>Unsaturated fatty acids:</strong> Plant foods such as nuts, seeds, and plant oils (olive and almond oil)</li>
                    <li><strong>Saturated fatty acids:</strong> Meat and dairy products</li>
                    <li><strong>Trans fatty acids:</strong> Processed foods and deep-fried foods</li>
                </ul>
                <p className="card-text">
